...
impl exports::component::main::main::Guest for Stub {
    ...
    fn test(x: exports::component::main::main::BodyHandle) -> () {
        ...
        let res = crate::component::main::main::test(x.to_import_owned());
            ...
            pub mod main {
                ...
                pub unsafe fn _export_test_cabi<T: Guest>(arg0: i32) {
                    unsafe {
                        ...
                        {
                            T::test(
                                super::super::super::super::component::main::async_io::Handle::from_handle(
                                    arg0 as u32,
                                ),
                            )
                        };
                ...
                macro_rules! __export_component_main_main_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "component:main/main#test")] unsafe extern "C" fn
...
A\x0e\x01B\x03\x01ps\x01@\x03\x06methods\x04args\0\x03rets\x01\0\x04\0\x06record\
...
\x05\x01B\x05\x02\x03\x02\x01\x04\x04\0\x0bbody-handle\x03\0\0\x01i\x01\x01@\x01\
\x01x\x02\x01\0\x04\0\x04test\x01\x03\x03\0\x13component:main/main\x05\x06\x01B\x05\
\x02\x03\x02\x01\x04\x04\0\x0bbody-handle\x03\0\0\x01i\x01\x01@\x01\x01x\x02\x01\
\0\x04\0\x04test\x01\x03\x04\0\x13component:main/main\x05\x07\x04\0\x16component\
:main/exports\x04\0\x0b\x0d\x01\0\x07exports\x03\0\0\0G\x09producers\x01\x0cproc\
essed-by\x02\x0dwit-component\x070.235.0\x10wit-bindgen-rust\x060.43.0";
#[inline(never)]
#[doc(hidden)]
